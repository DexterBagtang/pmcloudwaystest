                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                @foreach($salesrequests as $salesrequest)
                                    <tr>
                                        ...
                                        <td>
                                            @if($salesrequest->status != "Proposal Sent -> Proof Uploaded")
                                            <a class="btn btn-info btn-sm" href="{{url('sales-uploading-proofs-'.$salesrequest->id)}}">
                                                <i class="fas fa-pencil-alt"></i>
                                                Edit
                                            </a>
                                            @else
                                                <a class="btn btn-info btn-sm" href="{{url('sales-view-proposal-'.$salesrequest->id)}}">
                                                    <i class="fas fa-pencil-alt"></i>
                                                    Edit
                                                </a>
                                            @endif
