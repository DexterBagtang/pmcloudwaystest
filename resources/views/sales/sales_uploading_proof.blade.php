        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card card-cyan">
                    ...
                    @endif
                    <form action="{{url('sales-uploaded')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-body">
...
{{--                            <div id="show_pm" >--}}
                                <div class="form-group">
                                    <label for="inputPassword3" >Proof</label>
                                    <div class="col-sm-12">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="proof_of_sending" id="inputPassword3">
