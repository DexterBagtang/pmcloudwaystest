        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card card-cyan">
                    ...
                    @endif
                    <form action="{{url('sales-proceed')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-body">
                            ...
                            <div id="show_pm" >
                                <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="inputPassword3" >PO / NTP File</label>
                                    <div class="col-sm-12">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="po_ntp_files" id="inputPassword3">
                                            <label class="custom-file-label" for="exampleInputFile">Upload PO/NTP File</label>
                                        </div>
                                    </div>
                                </div>
                                </div>
