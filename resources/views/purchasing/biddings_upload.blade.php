        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card card-cyan">
                    ...
                    @endif
                    <form action="{{url('bidders-uploaded')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="inputName" class="text-primary"><i class="fas fa-check-circle text-primary"></i> Project Design Approved by Supervisor ! </label>
                            </div>
