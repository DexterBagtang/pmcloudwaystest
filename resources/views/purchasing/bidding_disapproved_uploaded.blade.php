        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card card-cyan">
                    ...
                    @endif
                    <form action="{{url('rebid-bidding')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-body">
                            <input type="hidden" name="id" value="{{$sales->id}}">
                            <input type="hidden" name="old_project_files" value="{{$sales->project_requirement_files}}">
                            <input type="hidden" name="old_bid_file" value="{{$sales->bid_file}}">
                            ...
                            <div class="form-group">
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>Contractor Name</th>
                                        <th>Total Cost</th>
                                        <th><span class="btn btn-success"><i class="fa fa-plus-square"></i></span></th>
                                    </tr>
                                    </thead>
                                    <tbody class="increment5">
                                    ...
                                    <tr class="existing">
                                        ...
                                        <td><input type="text" name="trade[]" class="form-control" value="{{$bidder->trade}}" required></td>
                                        <td><input type="text" name="contractor_name[]" class="form-control" value="{{$bidder->contractor_name}}" required></td>
                                        <td><input type="number" name="total_cost[]" class="form-control" value="{{$bidder->total_cost}}" required></td>
                                        <td>
{{--                                            <a href="{{url('delete-bidding-'.$bidder->id)}}">--}}
...
{{--                                            </a>--}}
                                    ...
                                    <tbody class="clone5 d-none">
                                    <tr class="trclone">
                                        <td><input type="text" name="trade2[]" class="form-control"></td>
                                        <td><input type="text" name="contractor_name2[]" class="form-control"></td>
                                        <td><input type="number" name="total_cost2[]" class="form-control"></td>
                                        <td><span class="btn btn-danger"><i class="fa fa-trash-alt"></i></span></td>
                                    </tr>
                                    </tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="bid_file" id="inputPassword3">
                                                <label class="custom-file-label" for="exampleInputFile">New Bid File</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{--                            </div>--}}
                            ...
                            <div class="form-group">
                                <label for="inputDescription">Remarks</label>
                                <textarea id="inputDescription" name="pm_bidders_remarks" class="form-control" readonly rows="2" required>{{$sales->pm_bidders_remarks}}</textarea>
                            </div>
