        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card card-cyan">
                    ...
                    @endif
                    <form action="{{url('review-approve-design')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-body">
                            ...
                            <div id="show_remark">
                                <div class="form-group">
                                    <label for="inputDescription">Remarks</label>
                                    <textarea id="inputDescription" name="pm_design_remarks" class="form-control" rows="2">{{$sales->pm_design_remarks}}</textarea>
                                </div>
                            </div>
...
{{--                                <div class="col-sm-4">--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label for="inputDescription">Upload Single-Line Diagram </label>--}}
...
{{--                                <div class="col-sm-4">--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label for="inputDescription">Upload Bill of Quantities </label>--}}
