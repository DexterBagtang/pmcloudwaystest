        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card card-cyan">
                    ...
                    @endif
                    <form action="{{url('review-selected-bidder')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
{{--                                            <input type="hidden" name="bidder" value={{null}}>--}}
                                            <input type="checkbox" class="form-control" name="bidder[]" value="{{$bidder->id}}" {{($bidder->status != null) ? 'checked' : ''}} >
{{--                                            @if($bidder->status == 0)--}}
{{--                                            <a  href="{{url('review-select-bidder-'.$bidder->id)}}" class="btn btn-danger" >Select</a>--}}
{{--                                            @else--}}
{{--                                                <a href="{{url('review-select-bidder-'.$bidder->id)}}" title="Cancel" class="btn btn-success">Selected</a>--}}
{{--                                            @endif--}}
                                        </td>
                                    </tr>
                                    @endforeach
...
{{--                            </div>--}}
                            ...
                            <div id="show_remark">
                                <div class="form-group">
                                    <label for="inputDescription">Remarks</label>
                                    <textarea id="inputDescription" name="pm_bidders_remarks" class="form-control" rows="2" required></textarea>
                                </div>
                            </div>
