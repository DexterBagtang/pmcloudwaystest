        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card card-pink">
                    ...
                    @endif
                    <form action="{{url('assigned-uploaded')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-body">
                            ...
                            <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="inputDescription">CER </label>
                                            <div class="input-group mb-3 increment">
                                                <input type="file" name="cer[]" class="form-control" required>
                                            ...
                                            <div class="clone d-none">
                                                <div class="input-group mb-3">
                                                    <input type="file" name="cer[]" class="form-control">
                                                    <div class="input-group-append">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="inputDescription">COPA </label>
                                            <div class="input-group mb-3 increment3">
                                                <input type="file" name="copa[]" class="form-control" required>
                                                <div class="input-group-append">
                                            ...
                                            <div class="clone3 d-none">
                                                <div class="input-group mb-3 tertiary" >
                                                    <input type="file" name="copa[]" class="form-control">
                                                    <div class="input-group-append">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="inputDescription">COCA</label>
                                            <div class="input-group mb-3 increment2">
                                                <input type="file" name="coca[]" class="form-control" required>
                                                <div class="input-group-append">
                                            ...
                                            <div class="clone2 d-none">
                                                <div class="input-group mb-3 danger">
                                                    <input type="file" name="coca[]" class="form-control">
                                                    <div class="input-group-append">
