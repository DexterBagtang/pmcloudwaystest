        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card card-cyan">
                    ...
                    @endif
                    <form action="{{url('revenue-uploaded-bid-summary')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <a class="form-control overflow-hidden" title="{{$sales->bid_file}}" target="_blank|_top" readonly href="{{asset('/files/bidfiles/'.$sales->bid_file)}}"><i class="fas fa-file mr-2"></i>
                                            {{$sales->bid_file}}
                                        </a>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <a class="form-control overflow-hidden" title="{{$sales->proposal_files}}" target="_blank|_top" readonly href="{{asset('/files/proposal_files/'.$sales->proposal_files)}}"><i class="fas fa-file mr-2"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="inputDescription">PO / NTP</label>
                                        <a class="form-control overflow-hidden" title="{{$sales->po_ntp_files}}" target="_blank|_top" readonly href="{{asset('/files/pontpfiles/'.$sales->po_ntp_files)}}"><i class="fas fa-file mr-2"></i>
                                            {{$sales->po_ntp_files}}
                                        </a>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="inputDescription">New Proposal File</label>
                                        <a class="form-control overflow-hidden" title="{{$sales->proposal_files}}" target="_blank|_top" readonly href="{{asset('/files/proposal_files/'.$sales->proposal_files)}}"><i class="fas fa-file mr-2"></i>
                                            {{$sales->proposal_files}}
                                        </a>
                                    </div>
...
{{--                                        <select name="return" class="form-control custom-select" >--}}
{{--                                            <option selected disabled value="{{null}}">Select one</option>--}}
{{--                                            <option value="sales">Sales</option>--}}
{{--                                            <option value="assigned">Project Design</option>--}}
{{--                                            <option value="purchasing">Bidding</option>--}}
...
{{--                                </div>--}}
                            ...
                            <div class="form-group">
                                <div id="show_pm" >
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="inputPassword3" >Bid Summary</label>
                                            <div class="col-sm-12">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="bid_summary_files" id="inputPassword3">
                                                    <label class="custom-file-label" for="exampleInputFile">Bid Summary</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
{{--                                    <div class="col-sm-6">--}}
{{--                                        <div class="form-group">--}}
{{--                                            <label for="inputPassword3" >Proposal</label>--}}
{{--                                            <div class="col-sm-12">--}}
{{--                                                <div class="custom-file">--}}
{{--                                                    <input type="file" class="custom-file-input" name="proposal_files" id="inputPassword3">--}}
{{--                                                    <label class="custom-file-label" for="exampleInputFile">Upload Proposal</label>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
