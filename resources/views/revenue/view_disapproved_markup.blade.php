        ...
        <div class="row">
            <div class="col-md-10 offset-1">
                <div class="card card-cyan">
                    ...
                    @endif
                    <form action="{{url('revenue-marked')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($bidders as $bidder)
                                        <tr class="{{($bidder->status != null) ? 'bg-gradient-secondary' : ''}}">
                                            <td>{{$bidder->trade}}</td>
                                            <td>{{$bidder->contractor_name}}</td>
                                            <td>{{$bidder->total_cost}}</td>
                                            <td>
                                                <input type="radio" class="form-control" name="revenue_bidder[]" value="{{$bidder->id}}" {{($bidder->revenue_status != null) ? 'checked' : ''}}>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                            ...
                            <div class="row" id="show_pm" >
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputPassword3" >PhilCom Proposal</label>
                                        <div class="col-sm-12">
                                            <div class="custom-file">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="project_size" class="form-control custom-select" >
